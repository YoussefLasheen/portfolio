    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            _buildTile('Mobile App Development', '4 projects', null,
                AssetImage('assets/images/P2Logo.png')),
            _buildSeparator(),
            _buildTile('Wwb Development', '4 projects', null,
                AssetImage('assets/images/P2Logo.png')),
            _buildSeparator(),
            _buildTile('UI/UX Design', '4 projects', null,
                AssetImage('assets/images/P2Logo.png')),
          ],
        ),
      ),
